/* font8x8.h — 8x8 monochrome bitmap font (printable ASCII 0x20–0x7F).
 *
 * Derived from the public-domain "font8x8_basic" by Daniel Hepper
 * (https://github.com/dhepper/font8x8). Each glyph is 8 bytes, one per row,
 * with bit 0 = leftmost pixel (LSB-first horizontally).
 */
#ifndef FONT8X8_H
#define FONT8X8_H
